...
<div class="row">
<?php 
	if($_SESSION['orders']['role'] == 6 || $_SESSION['orders']['role'] == 7)
	{
		echo '	<button type="button" class="btn btn-primary single"><a style="color:white" href="/orders/public/reports/close/'.$data['report'][0]['report_id'].'"><span class="glyphicon glyphicon-remove"></span> Close</a></button>';
	}
?>
