...
<table class="table table-bordered">
	<thead>
	  	<tr><th colspan="18"><?= strtoupper($data['report'][0]['name']) ?></th><th colspan="4">Report type : <?= $type[$data['report'][0]['type']]?></th></tr>
	  	<tr>
	  		...
	  		<th colspan="4">Number of items : <?= count($data['report'])?></th>
	  	</tr>
	  	<tr>
	  		<th class="tdminus"></th>
		  	<th>UPC</th>
